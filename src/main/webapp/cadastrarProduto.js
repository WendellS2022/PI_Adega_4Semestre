...
function salvarImagemNoDiretorio(imagem, nomeArquivo) {
    // Diretório onde as imagens serão armazenadas
    String diretorio = "/imagens";

    // Chama o método saveFile da classe FileUploadHelper para salvar a imagem
    if (FileUploadHelper.saveFile(imagem, nomeArquivo, diretorio)) {
        console.log('Imagem salva com sucesso:', nomeArquivo);
    } else {
        console.log('Erro ao salvar a imagem:', nomeArquivo);
    }
}
