                       ...
                       <c:if test="${endereco.status == true}">
                           <div class="endereco">
                               <label class="form-check-label" for="endereco${endereco.idEndereco}">
                                   ${endereco.logradouro}, ${endereco.numero}, ${endereco.complemento}, ${endereco.bairro}, ${endereco.cidade}, ${endereco.uf}, ${endereco.cep}
                                   <div class="form-check">
                                       <input class="form-check-input" type="radio" name="enderecoFaturamento" value="${endereco.idEndereco}" id="enderecoFaturamento${endereco.idEndereco}" ${endereco.enderecoFaturamento ? 'checked' : ''} required>
                                       <label class="form-check-label mr-4 font-weight-bold" for="enderecoFaturamento${endereco.idEndereco}">Endereço de faturamento</label>
